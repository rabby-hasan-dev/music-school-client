    ...
    return (
        <div className='grid lg:grid-cols-2 gap-4'>
            <div>
                ...
                <p className="text-xl">Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi acc umsan ipsum</p>
                ...
                <button className="btn">Red More</button>
            </div>
            <div className='grid grid-cols-2 gap-6' >
                <img className='w-25'  src={gitar1} alt="" />
                <img src={gitar2} alt="" />
            </div>
        </div>
    );
